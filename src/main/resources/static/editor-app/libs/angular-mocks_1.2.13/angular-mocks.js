 ...
 * The following code shows how to setup and use the mock backend when unit testing a web.
 * First we create the web under test:
 *
  <pre>
  // The web code
  ...
  <pre>
    ...
    describe('MyController', function() {
       ...
       beforeEach(inject(function($injector) {
         ...
         // The $web service is used to create instances of controllers
         var $web = $injector.get('$web');

         createController = function() {
           return $web('MyController', {'$scope' : $rootScope });
         };
       }));
       ...
       it('should send msg to server', function() {
         ...
         // the web will still send the request and
